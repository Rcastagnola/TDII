 ...
 * Private functions
 ****************************************************************************/
uint8_t getmousepos(void)
{
	return -2;
}


static void usb_connect_pullup(void)
{
	Chip_IOCON_PinMuxSet(LPC_IOCON,2,9,IOCON_FUNC0);
...
int main(void)
{
	...
	/*Inicializo el led comun, led alerta, y 2 pulsadores */
		Chip_IOCON_PinMuxSet(LPC_IOCON,2,8,IOCON_FUNC0);
